...
public class GameFrame extends JFrame implements Runnable{//, KeyListener {
    ...
    public GameFrame () {
        ...
        handler = new Handler();
        handler.addObject(new Mob(this,100,100,handler,ObjectId.Mob));
        handler.addObject(new Mob(this,100,100,handler,ObjectId.Mob));
        handler.addObject(new Mob(this,100,100,handler,ObjectId.Mob));
        //bat = new Bat (this);
        //ball = new Mob (this, bat);
        ...
        /* add stop button, show Animation Button, pause Animation Button and quit Animation Button*/
    ...
    //Add code here
        ...
        try{
            ...
            System.out.println("Error while creating buffer stratergy" + e);
            System.exit(0);
        }
    ...
    */
    ...
    private void gameRender(Graphics gScr){
        ...
        handler.render((Graphics2D)gScr);
